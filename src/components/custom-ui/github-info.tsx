          ...
          <div className="flex-1 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-inter font-medium text-foreground text-lg">Built for Cronos blockchain</span>
              </div>
              ...
              <div className="p-3 text-xs font-mono leading-5 overflow-x-auto">
                <div className="flex min-w-max">
                  ...
                  <div className="flex-1 min-w-max">
                    <div className="h-5"><span className="text-slate-600 dark:text-slate-400">import</span> <span className="text-slate-600 dark:text-slate-400">&#123;</span> <span className="text-blue-600 dark:text-blue-400">createMcpPaidHandler</span> <span className="text-slate-600 dark:text-slate-400">&#125;</span> <span className="text-slate-600 dark:text-slate-400">from</span> <span className="text-teal-600 dark:text-teal-500">&quot;cronos402/handler&quot;</span></div>
