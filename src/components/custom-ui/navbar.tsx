          ...
          <div className="flex items-center">
            <Link href="/">
              ...
              <div className="block sm:hidden">
                <Image src={symbolSrc} alt="Cronos402 Symbol" width={34} height={34} />
              </div>
              {/* Desktop: full logo */}
              <div className="hidden sm:flex items-center gap-3">
                <Image src={logoSrc} alt="Cronos402 Logo" width={112} height={72} />
              </div>
            </Link>
          </div>
              ...
              >
                ...
                <SheetHeader className="px-6 py-4">
                  <div className="flex items-center justify-between">
                    <Image src={logoSrc} alt="Cronos402 Logo" width={160} height={80} />
                    <SheetClose asChild>
