      ...
      sections: [
        {
          ...
          content: [
            ...
            {
              type: 'code',
              title: 'Cronos402 CLI (Direct Connection)',
              description: 'Use API key for authentication (recommended) or private key as alternative',
              language: 'bash',
              copyable: true,
              code: `# Using API Key (recommended)
npx cronos402 connect --urls ${urlUtils.getMcpUrl(serverData.serverId)} --api-key cronos402_YOUR_API_KEY_HERE

# Using Private Key (alternative)
npx cronos402 connect --urls ${urlUtils.getMcpUrl(serverData.serverId)} --evm YOUR_PRIVATE_KEY`
            }
          ]
        },
        {
...
import { createPaymentTransport } from "cronos402/client'
...
console.log('Available tools:', tools)`
      ...
      securityWarning: {
        ...
        message: 'Never share your private key publicly or in version control. The Cronos402 proxy handles payments securely using your private key locally. Consider using environment variables or secure key management solutions in production.'
      },
      quickLinks: [
        {
          text: 'View Tools',
        ...
        {
          text: 'Cronos402 Package',
          href: 'https://www.npmjs.com/package/cronos402',
          variant: 'internal',
          icon: Package
        }
      ]
