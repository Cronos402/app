...
export default function VisualProxy({
  ...
  const cronos402Ref = useRef<HTMLDivElement>(null)
  ...
  return (
    ...
    >
      <div className="inline-flex">
        <HighlighterText className="!text-foreground">CRONOS402 PROXY</HighlighterText>
      </div>
          ...
          <TooltipProvider>
            ...
            <div className="flex flex-col justify-center relative z-20">
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="relative z-20">
                    <Square ref={cronos402Ref}>
                      <div
                        className="bg-teal-700 dark:bg-teal-200"
                        style={{
                          width: "52px",
                          height: "52px",
                          maskImage: "url(/Cronos402-symbol-dark.svg)",
                          maskSize: "contain",
                          maskRepeat: "no-repeat",
                          maskPosition: "center",
                          WebkitMaskImage: "url(/Cronos402-symbol-dark.svg)",
                ...
                <TooltipContent>
                  <p>Cronos402 Proxy: we handle x402 payments and discoverability, you just get paid.</p>
                </TooltipContent>
              </Tooltip>
            </div>
          </TooltipProvider>
