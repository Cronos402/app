...
import { CRONOS_NETWORK, DEFAULT_NETWORK, SUPPORTED_CRONOS_NETWORKS } from '@/lib/constants/cronos'
...
// Network preference utilities - Uses centralized constants
export function getPreferredNetwork(): Network {
  // Default to cronos-testnet for testnet development
  return DEFAULT_NETWORK as Network
}

export function getSupportedNetworks(): Network[] {
  // Cronos-only supported networks from constants
  return [CRONOS_NETWORK.CRONOS, CRONOS_NETWORK.TESTNET] as Network[]
}
