...
export function getAllPaymentTokens() {
  ...
  return paymentTokens.sort((a, b) => (b.popularityScore ?? 0) - (a.popularityScore ?? 0));
}
...
export function getAllStablecoins() {
  ...
  return stablecoins.sort((a, b) => (b.popularityScore ?? 0) - (a.popularityScore ?? 0));
}
...
export const COMMONS_NAME = 'Cronos402 Commons';
